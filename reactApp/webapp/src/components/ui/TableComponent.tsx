...
const TableComponent = (): React.JSX.Element => {
    ...
    return (
        ...
        <div>
            <Table className="mb-20 overflow-x-hidden">
            ...
            <TableBody>

                {
                    ...
                    transactions.map((transaction: TransactionData , index: number) => (
                        ...
                        <TableCell className="font-medium text-center">{transaction.activityType}</TableCell>
                        <TableCell className="text-center">{transaction.fileName}</TableCell>
                        ...
                        <Link className="flex items-center justify-center"  href={`${transaction.subTxId}`} target="_blank">
                        
                                <TableCell className="cursor-pointer">{`${transaction.subTxId.slice(30)}`}</TableCell>

                        </Link>
                        <TableCell className="text-center">{transaction.status}</TableCell>
                        <TableCell className="text-center">{transaction.date.toLocaleString()}</TableCell>
